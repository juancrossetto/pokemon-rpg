...
export default async function FriendsPage({
  ...
  */
  ...
  const labels: FriendsLabels = {
    ...
    trade: {
      pickOffer: t("trade.pickOffer"),
      pickAccept: t("trade.pickAccept"),
      pickSubtitle: t("trade.pickSubtitle"),
      empty: t("trade.empty"),
      confirm: t("trade.confirm"),
      cancel: t("trade.cancel"),
      level: t("level"),
      incomingFrom: t("trade.incomingFrom", { name: "{name}" }),
      outgoingTo: t("trade.outgoingTo", { name: "{name}" }),
      accept: t("trade.accept"),
      decline: t("trade.decline"),
      cancelOffer: t("trade.cancelOffer"),
    },
    ...
    errors: {
      ...
      not_friends: t("errors.not_friends"),
      in_team: t("errors.in_team"),
      listed: t("errors.listed"),
      occupied: t("errors.occupied"),
      trade_locked: t("errors.trade_locked"),
      already_offered: t("errors.already_offered"),
      incoming_pending: t("errors.incoming_pending"),
      no_energy: t("errors.no_energy"),
    },
    ...
    toastOfferedTitle: t("toast.offeredTitle"),
    toastOfferedDetail: t("toast.offeredDetail"),
    toastTradedTitle: t("toast.tradedTitle"),
    toastTradedDetail: t("toast.tradedDetail"),
    toastCancelledTitle: t("toast.cancelledTitle"),
  };
